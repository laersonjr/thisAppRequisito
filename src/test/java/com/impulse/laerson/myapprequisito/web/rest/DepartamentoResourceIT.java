...
class DepartamentoResourceIT {
    ...
    public static Departamento createEntity(EntityManager em) {
        Departamento departamento = new Departamento().nome(DEFAULT_NOME);
        return departamento;
    }
    ...
    public static Departamento createUpdatedEntity(EntityManager em) {
        Departamento departamento = new Departamento().nome(UPDATED_NOME);
        return departamento;
    }
    ...
    void getAllDepartamentosWithEagerRelationshipsIsNotEnabled() throws Exception {
        ...
        restDepartamentoMockMvc.perform(get(ENTITY_API_URL + "?eagerload=false")).andExpect(status().isOk());
        verify(departamentoRepositoryMock, times(1)).findAll(any(Pageable.class));
    }
    ...
    void putExistingDepartamento() throws Exception {
        ...
        updatedDepartamento.nome(UPDATED_NOME);
