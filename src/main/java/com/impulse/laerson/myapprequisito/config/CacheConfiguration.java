package com.impulse.laerson.myapprequisito.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.impulse.laerson.myapprequisito.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.impulse.laerson.myapprequisito.repository.UserRepository.USERS_BY_EMAIL_CACHE);
