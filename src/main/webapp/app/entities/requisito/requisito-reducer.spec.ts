...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './requisito.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REQUISITO_LIST actions', async () => {
    ...
    it('dispatches FETCH_REQUISITO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REQUISITO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REQUISITO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REQUISITO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REQUISITO actions', async () => {
      const expectedActions = [
        {
