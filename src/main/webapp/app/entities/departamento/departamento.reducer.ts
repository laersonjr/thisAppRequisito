...
export const getEntities = createAsyncThunk('departamento/fetch_entity_list', async ({ page, size, sort }: IQueryParams) => {
...
export const createEntity = createAsyncThunk(
  ...
  async (entity: IDepartamento, thunkAPI) => {
    return axios.post<IDepartamento>(apiUrl, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError }
);
...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: IDepartamento, thunkAPI) => {
    return axios.put<IDepartamento>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError }
);
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: IDepartamento, thunkAPI) => {
    return axios.patch<IDepartamento>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError }
);
...
export const deleteEntity = createAsyncThunk(
  ...
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`;
    return await axios.delete<IDepartamento>(requestUrl);
  },
  { serializeError: serializeAxiosError }
);
