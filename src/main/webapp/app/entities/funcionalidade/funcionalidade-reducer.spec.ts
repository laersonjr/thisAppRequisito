...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FUNCIONALIDADE_LIST actions', async () => {
    ...
    it('dispatches FETCH_FUNCIONALIDADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FUNCIONALIDADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FUNCIONALIDADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FUNCIONALIDADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FUNCIONALIDADE actions', async () => {
      const expectedActions = [
        {
