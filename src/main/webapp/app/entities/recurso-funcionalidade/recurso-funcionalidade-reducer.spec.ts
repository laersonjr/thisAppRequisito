...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './recurso-funcionalidade.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RECURSOFUNCIONALIDADE_LIST actions', async () => {
    ...
    it('dispatches FETCH_RECURSOFUNCIONALIDADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RECURSOFUNCIONALIDADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RECURSOFUNCIONALIDADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RECURSOFUNCIONALIDADE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RECURSOFUNCIONALIDADE actions', async () => {
      const expectedActions = [
        {
