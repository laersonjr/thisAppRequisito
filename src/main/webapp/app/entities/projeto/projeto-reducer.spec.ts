...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './projeto.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJETO_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROJETO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROJETO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROJETO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROJETO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROJETO actions', async () => {
      const expectedActions = [
        {
